...
const DesktopSidebar = () => {
  ...
  return (
    <div className={cn(
      "h-screen sticky top-0 bg-card border-r border-border transition-all duration-300 md:flex flex-col justify-between hidden ",
          ...
          <nav className="space-y-1">
            {menuItems.map((item) => (
              ...
              >
                ...
                {!collapsed && (
                  <span className="transition-opacity animate-fade-in">
                    {item.name}
                  </span>
                )}
              </a>
